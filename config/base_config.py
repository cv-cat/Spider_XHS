...
KEYWORDS = "HKBU"  # Keyword search configuration, separated by English commas
...
# Control the number of crawled videos/posts (set to 0 for unlimited)
...
# Crawl interval (fixed seconds)
CRAWLER_MAX_SLEEP_SEC = 2

# Random sleep range for anti-detection (min, max seconds)
# Set to None to use fixed CRAWLER_MAX_SLEEP_SEC
# Example: (3, 6) will sleep randomly between 3-6 seconds
# Higher values reduce risk of detection but slow down crawling
CRAWLER_SLEEP_RANDOM_RANGE = (5, 10)
